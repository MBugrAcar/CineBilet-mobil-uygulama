...
import com.example.cinebilet.databinding.FragmentFifthBinding;
...
public class FifthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonFifth.setOnClickListener(v -> {
            ...
            NavHostFragment.findNavController(FifthFragment.this)
                    .navigate(R.id.action_FifthFragment_to_PaymentFragment, bundle);
        });
    }
